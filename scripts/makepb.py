...
def make_beam(mss, outfile='beam.fits', pixscale=10, size=5):
    ...
    cmd = 'wsclean -j 64 -parallel-reordering 4 -name __beam -use-idg -idg-mode cpu -channels-out 1 \
...
if __name__=='__main__':
    ...
    make_beam(mss, outfile, pixscale, size)
