...
def main(ms, skymodel, h5parm):
    ...
    sm.write(skymodel+'-beam.skymodel', applyBeam=False, clobber=True)
    ...
    for patch in patches:
        ...
        MSs.run(f'DP3 {parset_dir_para}/DP3-predict-beam.parset msin=$pathMS pre.sourcedb=$pathMS/{skymodel_basename} pre.sources={patch} \
                msout.datacolumn=MODEL_DATA pre.beammode=full pre.correctfreqsmearing=False', log='$nameMS_pre.log', commandType='DP3')
