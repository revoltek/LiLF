...
with w.if_todo('flag'):
    ...
    MSs_concat_all.run("DP3 " + parset_dir + f"/DP3-flag2.parset msin=$pathMS aoflagger.strategy={parset_dir}/LBAdefaultwideband.lua",
                       log="$nameMS_flag2.log", commandType="DP3")
    # extend flags
...
with w.if_todo('cal_fr'):
    ...
    lib_util.run_losoto(s, f'fr', [ms + '/fr.h5' for ms in MSs_fr.getListStr()],
                        [parset_dir + '/losoto-plot-ph.parset', parset_dir + '/losoto-plot-rot.parset',
                         parset_dir + '/losoto-plot-amp.parset', parset_dir + '/losoto-fr-rot.parset'])
    lib_util.check_rm('concat_fr.MS')
### DONE
