...
skymodel = '/home/fdg/scripts/model/VirgoA/VirA-LBA/2012/LBA-LOFAR.skydb'
...
MSs.run('DPPP '+parset_dir+'/DPPP-avg.parset msin=$pathMS msout=$nameMS.MS msin.datacolumn=DATA avg.freqstep=4 avg.timestep=4', \
...
#            [parset_dir + '/losoto-flag.parset',parset_dir+'/losoto-plot-amp.parset',parset_dir+'/losoto-bp.parset'])
    ...
    s.add('wsclean -reorder -name ' + imagename + ' -size 1700 1700 -mem 90 -j '+str(s.max_processors)+' \
            -scale 2arcsec -weight briggs -1.0 -niter 100000 -mgain 0.7 -minuv-l 100 \
            -multiscale -multiscale-scale-bias 0.5 -multiscale-scales 0,4,8,16,32 -auto-mask 5 -auto-threshold 0.005\
            -pol I -join-channels -fit-spectral-pol 3 -channels-out 15 '+MSs.getStrWsclean(), \
