...
for c in xrange(maxniter):
    ...
    lib_dd.make_voronoi_reg(directions, mosaic_image.maskname, outdir_reg='ddcal/images/c%02i/regions/' % c, out_mask='ddcal/masks/facets%02i.fits' % c, png='ddcal/skymodels/voronoi%02i.png' % c)
    lsm.group('facet', facet='ddcal/masks/facets%02i.fits' % c, root='Dir')
